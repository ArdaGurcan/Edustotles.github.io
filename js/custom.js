	...
	*/
	...
	function initTimer()
	{
		if($('.timer_list').length)
    	{
			...
			// Pzt - 1, Salı - 2 
			dates[0].setDate(dates[0].getDate() + (7 + 3 - dates[0].getDay()) % 7);
			dates[1].setDate(dates[1].getDate() + (7 + 4 - dates[1].getDay()) % 7);
			dates[2].setDate(dates[2].getDate() + (7 + 5 - dates[2].getDay()) % 7);
	    	...
	    	var target_date = dates[0].getTime();
	    	//----------------------------------------
